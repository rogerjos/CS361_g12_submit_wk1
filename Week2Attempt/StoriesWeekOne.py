...
#My own file before I frakenstein this code - Chido
from W2_UserHelpers import getOpenDonations, testReceiverOpenDonations, getReceiverDonations, testReceiverHistory
...
if __name__ == '__main__':
        ...
        stories = [
                ...
                'STORY 7: AS A RECEIVER I CAN SEE OPEN DONATIONS',
                'STORY 8: AS A RECEIVER I CAN SEE MY PAST DONATIONS'
        ]
        ...
        test['openReceiverDonations'] = [0, 0]#Test2
        test['receiverHistory'] = [0, 0]#Test2
        ...
        #Test_8
        printHeader(stories[8])
        testReceiverOpenDonations(test,db)
        #Test_9
        printHeader(stories[9])
        testReceiverHistory(test,db,users1[4])
